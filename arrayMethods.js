...
// CODE HERE
const totalPopulation  = populations.reduce((acc, population) => acc + population);
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((monst, i) => monst.CP > 200);
...
// CODE HERE
const mappedOrders = orders.map((elem,i) => {
...
// CODE HERE
const bobsTotal = purchases.filter((purch) => purch.owner === "Bob").reduce((acc, purch) => acc + purch.price, 0)
// console.log(bobsTotal);

//how scott showed us how to do it
const bobsTotal2 = purchases.reduce((acc, purchase) => {
